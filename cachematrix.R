## These functions cache a given matrix inversion to prevent 
## repeating the computationally complex inversion calculation.
## For the given matrix it will only be calculated once.


## makeCacheMatrix provides the functions to get and set the matrix cache
## as well as get and set the inverse cache
